<?php
/*
Widget-title: Regions list
Widget-preview-image: /assets/img/widgets_preview/top_regions.jpg
 */
?>
...
<div class="section-slim section-locations-list p80 container container-palette widget_edit_enabled">
    <div class="container">
        <h2 class="section-title left small"><?php echo lang_check('Popular Cities');?></h2><!-- ./ section title --> 
        <div class="box">
            <div class="locations-list">
                <?php $i=0;  foreach ($treefields as $key=>$item): ?>
                <?php //if ($i>3) break; ?>
                <div class="grid"><a href='<?php _che($item['url']);?>'><?php _che($item['title']);?></a></div>
                <?php $i++; endforeach; ?>
            </div>
        </div>
    </div>
</div> <!-- ./ Popular Cities list  --> 