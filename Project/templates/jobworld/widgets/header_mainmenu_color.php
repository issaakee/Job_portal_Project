<?php
/*
Widget-title: Main menu/Title/Actions
Widget-preview-image: /assets/img/widgets_preview/head_mainmenu_color.jpg
 */
?>
<div class="nav-bar nav-bar-color container container-palette widget_edit_enabled">
    <div class="container">
        <div class="flex-row">
