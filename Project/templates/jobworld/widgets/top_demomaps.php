<div class="section container container-palette section-body widget_edit_enabled">
    <div class="container">
    <div class="row">
        <div class="widget section-body no-border no-padding widget_edit_enabled">
                ...
                <div class="widget-header header-styles">
                    <h2 class="title"><?php echo lang_check('Select map');?></h2>
                </div>
                <div class="content-box">
                <div class="results_conteiner">
                    <ul class="list-maps row clearfix">
