...
<div class="section section-categories big container container-palette widget_edit_enabled">
    <div class="container">
        <div class="flex-categories">
            <?php $i=0;  foreach ($treefields as $key=>$item): ?>
            <?php if ($i>3) break; ?>
            <div class="item">
                <div class="header"><a href='<?php _che($item['url']);?>'> <i class="<?php _che($item['font_icon_code']);?>"></i></a></div>
                <div class="caption">
                    <h2 class="title"><a href='<?php _che($item['url']);?>'><?php _che($item['title']);?></a></h2>
                    
                    <ul class="item-cat-list">
                        <?php $k = 0; foreach ($item['childs'] as $value):?>
                        <?php if ($k>4) break; ?>
                        <li>
                            <a href='<?php _che($value['url']);?>'>
                                <?php _che($value['title']);?>
                            </a>
                        </li>
                        <?php $k++; endforeach;?>
                    </ul>
