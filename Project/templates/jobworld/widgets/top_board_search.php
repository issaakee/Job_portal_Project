<?php
/*
Widget-title: Search Board
Widget-preview-image: /assets/img/widgets_preview/top_board_search.jpg
 */
?>
<?php
...
<div class="section section-flat-search container container-palette bg-mask redirect_search static widget_edit_enabled">
    <div class="container">
        <div class="body">
            <div class="title"><?php echo lang_check('Get New Job.');?> <b><?php echo lang_check('Right Now.');?></b></div> <!-- ./ top search title --> 
            <div class="job-form">
                <form  action="{page_current_url}#main-search" class="search-form flex-row">
                    ...
                    <a href="#" id="search-start" class="btn btn-flat-search"><?php echo lang_check('Search');?><i class="fa fa-spinner fa-spin fa-ajax-indicator hidden"></i></a>
                </form>
            </div>
            <div class="flat-search-notification"><?php _che($count,0);?> <?php echo lang_check('new jobs posted in the last 7 days');?></div>
        </div> <!-- ./ top search body --> 
    </div>
</div> <!-- ./ top search -->