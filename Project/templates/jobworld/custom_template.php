...
<html lang="en">
    ...
    <body class="<?php _widget('custom_paletteclass'); ?> modal-backdrop-effect dissable-sticky <?php if(!empty($is_logged_other)):?> admin_access <?php endif;?>">
        <header>
        ...
        !empty($is_logged_other)
        ):?>
        <main class="container container-palette pt-75">
            <div class="container">
                <div class="wraper-row">
                    <div class="column-content">
                        <?php foreach ($widgets_order->right as $widget_filename) {
                            _widget($widget_filename);
                        }
                        ?>
                        <?php if(!empty($is_logged_other)):?>
        ...
        <footer class="footer container container-palette">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="flex-row">
                        <div class="right"><span class="copyright"><?php echo lang_check('All Right reserved');?> &#169;<?php echo date('Y');?>.  <?php echo lang_check('Made With ISHAK HAFDALLAH');?> </span></div><!-- ./ copyright --> 
                        <div class="left">
