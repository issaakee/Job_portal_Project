...
<?php
    ...
    echo form_dropdown('option'.$field_id.'_'.$lang_id.'_level_0', $drop_options, $drop_selected, 'class="wtl_search_types_input_tree form-control selectpicker base no-padding tree-input" id="sinputOption_'.$lang_id.'_'.$field_id.'_level_0'.'"');
    echo '</div>';
    ...
    for($ti=1;$ti<=$levels_num;$ti++)
    {
        ...
        echo '<div class="field-tree form-group col-sm-3">';
        echo form_dropdown('option'.$field_id.'_'.$lang_id.'_level_'.$ti, array(''=>$lang_empty), array(), 'class="form-control selectpicker  col-sm-3" id="sinputOption_'.$lang_id.'_'.$field_id.'_level_'.$ti.'"');
        echo '</div>';
    }
    echo '</div>';
