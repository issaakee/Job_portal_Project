...
<div class="">
    <div class="form-group-checkbox-line">
        <label class="checkbox">
            <input option_id="<?php echo $f_id; ?>" class="checkbox_am" type="checkbox" value="true<?php _che(${'options_name_'.$f_id}); ?>" /><?php _che(${'options_name_'.$f_id}); ?><span class="primary-text-color"></span>
        </label>
    </div>
</div>
